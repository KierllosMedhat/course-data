# Lecture 10 — JavaScript Basics: Syntax, Types & Control Flow
...
> - ✅ Create an HTML file with proper boilerplate — [Lecture 02](./02%20-%20Introduction%20to%20Web%20Development%20%26%20HTML5%20Basics.md)
> - ✅ Link external files (CSS, JS) from HTML — [Lecture 02](./02%20-%20Introduction%20to%20Web%20Development%20%26%20HTML5%20Basics.md)
> - ✅ Open browser DevTools (F12) and navigate to the Console tab — [Lecture 01](./01%20-%20Introduction%20to%20Computers%20%26%20Web%20Development.md)
> - ✅ Use VS Code and Live Server — [Lecture 01](./01%20-%20Introduction%20to%20Computers%20%26%20Web%20Development.md)
...
4. Write a function stub (we will cover functions deep in Lecture 11, but try writing a basic one) called `addTask(title)` that pushes a new task object into the array, auto-incrementing the `id`.
...
**Next Lecture:** [Lecture 11 — Functions, Arrays & Objects](../11%20-%20Functions%2C%20Arrays%20%26%20Objects/11%20-%20Functions%2C%20Arrays%20%26%20Objects.md)

### 📚 Extensive Tutorials & Resources
- **MDN Web Docs:** [JavaScript First Steps](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/First_steps)
- **Javascript.info:** [Variables - Declaring and naming variables](https://javascript.info/variables)
- **MDN Web Docs:** [Grammar and Types in JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Grammar_and_types)
...
- **FreeCodeCamp:** [JavaScript Loops Explained: for, while, do...while, and more](https://www.freecodecamp.org/news/javascript-loops-explained-for-loop-while-loop-do-while-loop-and-more/)
