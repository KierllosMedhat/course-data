# Lecture 15 — ES6+ Modern Features & JavaScript Tooling
...
We covered this in Lecture 13, but here's a complete class example combining everything:
...
**2. Migrate your code** from Lecture 14 into the new `src/` folder.
...
**Next Lecture:** [Lecture 16 — Bootstrap 5: Grid System, Components & Utilities](../../Module%204%20-%20CSS%20Frameworks/16%20-%20Bootstrap%205%20%E2%80%94%20Grid%20System%2C%20Components%20%26%20Utilities/16%20-%20Bootstrap%205%20%E2%80%94%20Grid%20System%2C%20Components%20%26%20Utilities.md) — Module 3 begins!
### 📚 Extensive Tutorials & Resources
- **MDN Web Docs:** [Template Literals Reference](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals)
- **Javascript.info:** [Optional Chaining '?.' Guide](https://javascript.info/optional-chaining)
- **MDN Web Docs:** [Classes in JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes)
- **Javascript.info:** [Map and Set Collections](https://javascript.info/map-set)
- **Vite Guide:** [Getting Started with Vite](https://vite.dev/guide/)
- **ESLint Documentation:** [Configure ESLint using Flat Config](https://eslint.org/docs/latest/use/configure/configuration-files)
- **FreeCodeCamp:** [Modern ES6 JavaScript Features Explained](https://www.freecodecamp.org/news/write-less-do-more-with-javascript-es6-features/)
