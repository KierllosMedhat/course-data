# Lecture 11 â€” Functions, Arrays & Objects
...
More importantly, arrow functions do **not** have their own `this` binding. They inherit `this` from the surrounding lexical scope. We will explore `this` deeply in Lecture 13, but know that arrow functions are the safest choice for callbacks.
...
function createValidator(minLength) {
  ...
  // It "remembers" the minLength variable due to Closures (Lecture 13)
...
**Next Lecture:** [Lecture 12 â€” DOM Manipulation & Events](../12%20-%20DOM%20Manipulation%20%26%20Events/12%20-%20DOM%20Manipulation%20%26%20Events.md)

### 📚 Extensive Tutorials & Resources
- **MDN Web Docs:** [JavaScript Functions Guide](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Functions)
- **Javascript.info:** [Arrow Functions, the Basics](https://javascript.info/arrow-functions-basics)
- **MDN Web Docs:** [Indexed Collections (Arrays)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Indexed_collections)
- **Javascript.info:** [Array Methods](https://javascript.info/array-methods)
- **MDN Web Docs:** [Working with Objects](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Working_with_Objects)
- **FreeCodeCamp:** [JavaScript Array Methods Explained with Examples](https://www.freecodecamp.org/news/javascript-array-methods-explained-with-examples/)
- **CSS-Tricks:** [Destructuring Assignment in ES6](https://css-tricks.com/destructuring-assignment-in-es6/)
