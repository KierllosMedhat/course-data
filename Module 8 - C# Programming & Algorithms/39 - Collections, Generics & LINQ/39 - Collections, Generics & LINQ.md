# Lecture 39 — Collections, Generics & LINQ
...
**Next Lecture:** [Lecture 40 — Delegates, Events, Async/Await & Exception Handling](../40%20-%20Data%20Structures%20in%20C%23%20-%20Stacks%2C%20Queues%2C%20Trees%20%26%20Graphs/40%20-%20Data%20Structures%20in%20C%23%20-%20Stacks%2C%20Queues%2C%20Trees%20%26%20Graphs.md)

### 📚 Extensive Tutorials & Resources
- **Source:** [Microsoft Learn: Collections in C#](https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/collections)
- **Source:** [CodeMaze: C# List Class - Guide with Examples](https://code-maze.com/csharp-list/)
- **Source:** [C# Corner: Introduction to C# Generics](https://www.c-sharpcorner.com/article/generics-in-c-sharp/)
- **Source:** [CodeMaze: LINQ in C# - Basic to Advanced Guide](https://code-maze.com/csharp-linq/)
- **Source:** [DotNetTutorials: LINQ Tutorials for Beginners and Professionals](https://dotnettutorials.net/course/linq-tutorials-csharp/)
- **Source:** [Microsoft Learn: Introduction to LINQ Queries (C#)](https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/linq/introduction-to-linq-queries)
- **Source:** [FreeCodeCamp: C# LINQ Tutorial - How to Query Collections](https://www.freecodecamp.org/news/c-sharp-linq-tutorial-how-to-query-collections-with-linq/)
