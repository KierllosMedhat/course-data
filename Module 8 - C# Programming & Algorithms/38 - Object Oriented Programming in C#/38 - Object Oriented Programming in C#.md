# Lecture 38 — Object-Oriented Programming in C#
...
- Understand basic C# syntax and methods (Lecture 34).
...
As introduced in Lecture 34, primary constructors reduce boilerplate:
...
**Next Lecture:** [Lecture 39 — Collections, Generics & LINQ](../39%20-%20Collections%2C%20Generics%20%26%20LINQ/39%20-%20Collections%2C%20Generics%20%26%20LINQ.md)
### 📚 Extensive Tutorials & Resources
- **Source:** [Microsoft Learn: Object-Oriented Programming (C#)](https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/tutorials/oop)
- **Source:** [CodeMaze: Polymorphism in C# (Virtual, Override, and Sealed)](https://code-maze.com/csharp-polymorphism/)
- **Source:** [C# Corner: Encapsulation in C# with Examples](https://www.c-sharpcorner.com/article/encapsulation-in-c-sharp-with-examples/)
- **Source:** [DotNetTutorials: Abstract Class in C# with Examples](https://dotnettutorials.net/lesson/abstract-class-in-csharp/)
- **Source:** [CodeMaze: Interfaces in C#](https://code-maze.com/csharp-interfaces/)
- **Source:** [Microsoft Learn: Interface vs Abstract Class Design Guidelines](https://learn.microsoft.com/en-us/dotnet/standard/design-guidelines/abstractions-abstract-types-and-interfaces)
- **Source:** [FreeCodeCamp: Object-Oriented Programming in C# - Explained with Code Examples](https://www.freecodecamp.org/news/object-oriented-programming-in-c-sharp/)
