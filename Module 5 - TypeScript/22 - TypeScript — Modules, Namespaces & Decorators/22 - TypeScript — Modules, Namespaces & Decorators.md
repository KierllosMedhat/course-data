...
- **TypeScript Handbook:** [Modules - Standard ES Modules and Type-only Imports](https://www.typescriptlang.org/docs/handbook/2/modules.html)
- **TypeScript Handbook:** [Declaration Files and Ambient Typings](https://www.typescriptlang.org/docs/handbook/declaration-files/introduction.html)
- **TypeScript Handbook:** [TC39 Decorators Standard in TypeScript 5.0](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-5-0.html#decorators)
- **TypeScript Handbook:** [Module Resolution and Path Alias Mapping](https://www.typescriptlang.org/docs/handbook/module-resolution.html)
- **FreeCodeCamp:** [How to Write Custom Declaration Files for Untyped JS](https://www.freecodecamp.org/news/how-to-write-custom-declaration-files-in-typescript/)
- **W3Schools:** [TypeScript Modules and File Organization](https://www.w3schools.com/typescript/typescript_modules.php)
- **LogRocket Blog:** [A Practical Guide to Modern TypeScript 5.0 Decorators](https://blog.logrocket.com/practical-guide-typescript-5-decorators/)

---

**Next Lecture:** [Lecture 23 — TypeScript with Modern Tooling & Testing](../23%20-%20TypeScript%20with%20Modern%20Tooling%20%26%20Testing/23%20-%20TypeScript%20with%20Modern%20Tooling%20%26%20Testing.md)
