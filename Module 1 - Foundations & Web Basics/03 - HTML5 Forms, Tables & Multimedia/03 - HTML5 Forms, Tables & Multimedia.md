# Lecture 03 — HTML5 Forms, Tables & Multimedia
...
<figure>
  ...
  <figcaption>
    Figure 1: Demonstration of the completed project from Lecture 03.
  </figcaption>
</figure>
...
Continue building your Developer Portfolio from Lecture 02.
...
- Add form validation feedback with JavaScript (we'll learn this in Lecture 12)
...
**Next Lecture:** [Lecture 04 — CSS3 Fundamentals & Selectors →](../../Module%202%20-%20CSS%20Styling%20%26%20Layouts/04%20-%20CSS3%20Fundamentals%20%26%20Selectors/04%20-%20CSS3%20Fundamentals%20%26%20Selectors.md)
### 📚 Extensive Tutorials & Resources
- **Source:** [MDN Web Docs - Your First HTML Form](https://developer.mozilla.org/en-US/docs/Learn/Forms/Your_first_form)
- **Source:** [MDN Web Docs - HTML Table Basics and Semantics](https://developer.mozilla.org/en-US/docs/Learn/HTML/Tables/Basics)
- **Source:** [MDN Web Docs - Video and Audio Multimedia Content](https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content)
- **Source:** [Web.dev - Learn Forms: Input Types and Validation Deep Dive](https://web.dev/learn/forms)
- **Source:** [FreeCodeCamp - HTML Forms Tutorial: Registration Form Course](https://www.freecodecamp.org/news/learn-html-forms-by-building-a-registration-form/)
- **Source:** [WebAIM - Creating Accessible Forms and Fields](https://webaim.org/techniques/forms/)
- **Source:** [MDN Web Docs - The Dialog Element: HTML Native Modals](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog)
