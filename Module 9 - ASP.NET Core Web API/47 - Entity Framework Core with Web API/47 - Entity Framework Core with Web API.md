# Lecture 47 — Entity Framework Core with Web API
...
**Next Lecture:** [Lecture 48 — Authentication & Authorization in ASP.NET Core 10](../48%20-%20Authentication%20%26%20Authorization%20in%20ASP.NET%20Core%2010/48%20-%20Authentication%20%26%20Authorization%20in%20ASP.NET%20Core%2010.md)
### 📚 Extensive Tutorials & Resources
- **Microsoft Learn:** [ASP.NET Core Web API with EF Core](https://learn.microsoft.com/en-us/aspnet/core/tutorials/first-web-api)
- **CodeMaze:** [Entity Framework Core in ASP.NET Core Web API](https://code-maze.com/net-core-series/#efcore)
- **CodeMaze:** [Repository Pattern with ASP.NET Core](https://code-maze.com/generic-repository-pattern-csharp-aspnet-core/)
- **DotNetTutorials:** [Repository Pattern in ASP.NET Core Web API](https://dotnettutorials.net/lesson/repository-pattern-in-asp-net-core/)
- **CodeMaze:** [AutoMapper in ASP.NET Core Web API](https://code-maze.com/automapper-net-core/)
- **Microsoft Learn:** [Querying Data - Pagination in EF Core](https://learn.microsoft.com/en-us/ef/core/querying/pagination)
- **DotNetTutorials:** [Pagination in ASP.NET Core Web API](https://dotnettutorials.net/lesson/pagination-in-asp-net-core-web-api/)
